...
public class ChallengeSystem : MonoBehaviour
{
    ...
    {
        if (challenge == null || challenge.rewardType == ChallengeRewardType.ShopRating)
            return 0;

        return challenge.scope switch
        {
            ChallengeScope.Daily => 10,
            ChallengeScope.Monthly => 50,
            ChallengeScope.Lifetime => 25 * Mathf.Max(1, challenge.chainStage),
            _ => 0
        };
    }
